...
/*******************************************************************************
 * Instances of class {@code IShape} represent ...
 *
 * @author  Jan DOLEŽAL
...
//== CONSTUCTORS AND FACTORY METHODS ===========================================
     ...
     *
     */
    public ShapeI(Point centralPoint)
    {
        super(centralPoint);
    }
...
//    public static void main(String[] args)  {  test();  }
    ...
    public Point getBrick4()
    {
         switch(rotate)
       {
           case 0: return new Point(centralBrick.x, centralBrick.y + 2);

           case 1: return new Point(centralBrick.x - 2, centralBrick.y);

           case 2: return new Point(centralBrick.x , centralBrick.y - 2);

           default: return new Point(centralBrick.x + 2, centralBrick.y);
       }
    }
